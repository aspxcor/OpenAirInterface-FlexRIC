...
mcs_event_trigger_t mcs_dec_event_trigger_asn(size_t len, uint8_t const buf[len])
{
  assert(0!=0 && "Not implemented");
  assert(buf != NULL);
  mcs_event_trigger_t avoid_warning;
...
mcs_action_def_t mcs_dec_action_def_asn(size_t len, uint8_t const action_def[len])
{
  ...
  mcs_action_def_t avoid_warning;
  return avoid_warning;
}
...
mcs_call_proc_id_t mcs_dec_call_proc_id_asn(size_t len, uint8_t const call_proc_id[len])
{
  ...
  mcs_call_proc_id_t avoid_warning;
  return avoid_warning;
}
