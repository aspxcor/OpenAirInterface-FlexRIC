...
#include "../../../executables/agent_if/ie/mcs_control_ie.h"
#include <pthread.h>
...
extern pthread_cond_t dl_mcs_has_changed;
extern pthread_mutex_t dl_mcs_lock;
extern pthread_cond_t ul_mcs_has_changed;
extern pthread_mutex_t ul_mcs_lock;

typedef struct{
  ul_dl_mcs_conf_t mcs_conf;
  int64_t tstamp;
} ul_dl_mcs_conf_timestamp_t; 

extern ul_dl_mcs_conf_timestamp_t ul_mcs_value;
extern ul_dl_mcs_conf_timestamp_t dl_mcs_value;

extern pthread_t dl_scanthreadid;
extern pthread_t ul_scanthreadid;
